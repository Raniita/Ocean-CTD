...
def live_plot(filename, station):
    ...
    def animate(i):
        ...
        try:
            ...
            plt.cla()
            plt.plot(x1_values[imin:i], y_values[imin:i], color="orange", label="cdom_ppb")
            plt.plot([],[], ' ', label="CDOM: "+last_cdom)
            plt.plot(x2_values[imin:i], y_values[imin:i], color="blue", label="pe_ppb")
            plt.plot([],[], ' ', label="PE: "+last_phy)
            plt.plot(x3_values[imin:i], y_values[imin:i], color="green", label="chl_ppb")
